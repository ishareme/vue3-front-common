<template>
    <div class="relative leading-[0px]">
        ...
        <input
            ...
            v-model="text"
            :maxlength="max"
            class="w-full border-gray-200 dark:border-zinc-600 dark:bg-zinc-800 duration-100 dark:text-zinc-400 border outline-0 py-0.5 px-1 text-sm rounded-sm focus:border-blue-400"
        />
        <!-- 多行 -->
        <textarea
